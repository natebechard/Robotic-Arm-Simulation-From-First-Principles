...
\begin{center}
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{pendulum vector field_with_IVP.png}}%
...
\begin{center}
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{Damped driven vector field}}%
...
\begin{center}
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{underpowered different positions.png}}%
...
\begin{center}
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{underpowered positive velocity.png}}%
...
\begin{center}
\makebox[\textwidth][c]{\includegraphics[width=1.4\textwidth]{underpowered negative.png}}%
